...
class Member(models.Model):
    ...
    member_name = models.CharField(unique=True, max_length=20)
    member_password = models.CharField(max_length=128)
    member_birth = models.DateField()
    last_update = models.DateTimeField()
    member_email = models.CharField(unique=True, max_length=200)
    member_avatar = models.CharField(max_length=100)
